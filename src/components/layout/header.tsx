    ...
    <header className="sticky top-0 z-50 flex h-[var(--header-height)] w-full items-center border-b border-border/40 bg-background/60 backdrop-blur-xl px-4 lg:px-8 transition-all duration-300">
      <div className="flex items-center gap-4 w-full">
        ...
        <Link
          ...
          className="flex items-center gap-2.5 font-bold text-xl tracking-tight shrink-0 group"
        >
        ...
        <div className="flex flex-1 items-center justify-end gap-2 sm:gap-4">
          <DropdownMenu>
            ...
            <DropdownMenuContent
              align="end"
              className="w-64 rounded-xl shadow-xl border-border/40"
            >
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                className="relative h-9 w-9 rounded-full ml-1 p-0 hover:ring-2 hover:ring-primary/20 transition-all"
              >
            ...
            <DropdownMenuContent
              className="w-64 rounded-xl shadow-xl border-border/40 p-2"
              align="end"
              forceMount
            >
              ...
              <DropdownMenuItem
                asChild
                className="cursor-pointer rounded-lg my-1 hover:bg-primary/5 transition-colors"
              >
              ...
              <form action={logout}>
                <DropdownMenuItem asChild>
                  <button
                    type="submit"
                    className="w-full flex items-center cursor-pointer rounded-lg text-destructive focus:text-destructive focus:bg-destructive/10 transition-colors"
                  >

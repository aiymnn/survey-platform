      ...
      <div className="flex flex-col gap-8 w-full max-w-7xl mx-auto">
          ...
          <div className="p-4 rounded-xl bg-primary/10 border border-primary/20 flex items-start gap-3">
            ...
            <div className="text-sm font-medium text-foreground">
              ...
              <p className="text-muted-foreground font-normal mt-1">
                Profile settings (Username & Email) are locked and can only be
                modified by the System Superadmin.
              </p>
            </div>
          </div>
        )}
        ...
        <Card className="border-border/40 shadow-sm bg-card/50 backdrop-blur-sm">
          <CardHeader>
            ...
            <CardDescription>Update your global app identity.</CardDescription>
          </CardHeader>
          ...
          <form
            action={async (formData: FormData) => {
              ...
              if (result.error) {
                ...
                serverRedirect(
                  `/admin/settings?success=${encodeURIComponent(result.success)}`
                );
              }
            }}
          >
            <CardContent className="space-y-6">
              {searchParams.success && (
                <div className="p-4 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-sm text-emerald-500 flex items-start gap-3">

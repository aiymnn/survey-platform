    ...
    <div className="w-full space-y-6 animate-in fade-in zoom-in-95 duration-300">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Customize the messages shown to users before and after they take the survey.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            />
            <p className="text-xs text-muted-foreground">This is shown on the very first page before questions start.</p>
          </div>
          <div className="space-y-2">
            <Label htmlFor="end">End Message (Optional)</Label>
            <Textarea 
              id="end" 
              ...
              className="resize-none h-24"
            />
            <p className="text-xs text-muted-foreground">This is shown after the respondent submits their answers.</p>
          </div>
        </CardContent>
      </Card>
    </div>
